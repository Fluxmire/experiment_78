...
class Pipeline:
    ...
    def __init__(
        ...
        *,
        ...
        coder_v1_ensemble_size: int = 0,
        coder_v1_ensemble_temperature: float = 0.3,
        ...
        self.coder_v1_ensemble_size = coder_v1_ensemble_size if coder_v1 is not None else 0
        self.coder_v1_ensemble_temperature = coder_v1_ensemble_temperature
        self.multigen_size = coder_ensemble_size + self.coder_v1_ensemble_size
    ...
    async def _run(self, task: PipelineTask) -> None:
        ...
        for iteration in range(self.max_iter + 1):
            ...
            if iteration == 0 and self.multigen_size > 1:

                await multigen_first_iter(
                    task,
                    coder=self.coder,
                    coder_v1=self.coder_v1,
                    judge=self.judge,
                    ...
                    ensemble_size_v1=self.coder_v1_ensemble_size,
                    ensemble_temperature_v1=self.coder_v1_ensemble_temperature,
